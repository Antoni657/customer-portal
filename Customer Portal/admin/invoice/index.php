...
<div class="card">
	...
	<div class="card-header d-flex justify-content-between align-items-center text-white" style="background-color: #facc15;">
		<h3 class=" mb-0"style="margin: 0 auto;">Billing List</h3>
		<div class="card-tools">
			<a href="<?php echo base_url."admin?page=invoice/manage_invoice" ?>" id="create_new" class="btn btn-flat btn-sm btn-primary">Add New Billing</a>
		</div>
		</div>
	</div>
	<div class="card-body">
					...
					?>
						<tr>
							...
							<td class="text-center">
                                <?php if($row['status'] == 1): ?>
                                    <span class="badge badge-success rounded-pill" style="font-size: 1rem;">Paid</span>
                                <?php else: ?>
                                    <span class="badge badge-primary rounded-pill" style="font-size: 1rem;">Pending</span>
                                <?php endif; ?>
                            </td>
							<td align="center">
...
<script>
	$(document).ready(function(){
		$('.delete_data').click(function(){
			_conf("Are you sure to delete this Billing permanently?","delete_invoice",[$(this).attr('data-id')])
		})
