...
<div class="card">
    ...
    <div class="card-header text-center text-white" style=" background-color: #facc15;" >
        <h3 class=""><?php echo isset($id) ? "Update Billing - ".$invoice_code : 'Create New Billing' ?></h3>
    </div>
    </div>
    <div class="card-body">
                ...
                <div class="col-md-12">
                    <fieldset class="border-bottom border-info">
                        <div class="row">
                            <div class="form-group col-sm-4">
                                <label for="client_id" class="control-label text-info">Customer</label>
                                <select name="client_id" id="client_id" class="custom-select custom-select-sm rounded-0 select2" data-placeholder="Please Select Customer Here" required>
                    ...
                    <fieldset class="border-bottom border-info">
                        ...
                        <div class="row align-items-end">
                            <div class="form-group col-sm-4">
                                <label for="service_id" class="control-label text-info">Products</label>
                                <select id="service_id" class="custom-select custom-select-sm rounded-0 select2" data-placeholder="Please Select Products Here">
                            ...
                            <div class="form-group col-sm-4">
                               <button class="btn btn-flat btn-primary btn sm" type="button" id="add_to_list"> Add to List</button>
                            </div>
                        </div>
                        <table class="table table-hover table-striped table-bordered" id="service-list">
                            ...
                            <thead>
                                ...
                                style="background: #466d75 !important;">
                                    <th class="px-2 py-2 text-center"></th>
                                    <th class="px-2 py-2 text-center">Products</th>
                            ...
                            <?php 
                                ...
                                while($row = $qry_meta->fetch_assoc()):
                                    $total += $row['price'];
                            ?>
                                <tr style="background-color: #75b4c2;">
                            ...
                            <tfoot>
                                <tr class=" text-light disabled"
                                style="background-color: #75b4c2;">
                                ...
                                <tr class=" text-light disabled" style="background-color: #75b4c2;">
                                    <th class="px-2 py-2 text-right" colspan="3">
                                        Grand Total
