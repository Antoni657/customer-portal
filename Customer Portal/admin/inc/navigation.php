...
<!-- Main Sidebar Container -->
      <aside class="main-sidebar elevation-4 sidebar-no-expand  disabled" style="background-color: #032830; ">
        <!-- Brand Logo -->
        <a href="<?php echo base_url ?>admin" class="brand-link  text-sm" style="background-color: #fde047; ">
        <img src="<?php echo validate_image($_settings->info('logo'))?>" alt="Store Logo" class="brand-image img-circle elevation-3 " style="width: 1.8rem;height: 1.8rem;max-height: unset;object-fit:scale-down;object-position:center center">
        ...
        <div class="sidebar os-host os-theme-light os-host-overflow os-host-overflow-y os-host-resize-disabled os-host-transition os-host-scrollbar-horizontal-hidden">
          ...
          <div class="os-padding">
            <div class="os-viewport os-viewport-native-scrollbars-invisible" style="overflow-y: scroll;">
              <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%; margin-top: 4rem;">
