...
<div class="card-header text-center text-white" style=" background-color: #facc15;" >
    ...
    <div class="card-body">
        <div class="container-fluid" id="print_out">
            ...
            <h3 class="text-info">Billing: <b><?php echo isset($invoice_code) ? $invoice_code :'' ?></b></h3>
            <fieldset class="border-bottom border-info">
                <div class="row">
                    <div class="form-group col-sm-4">
                        <label for="client_id" class="control-label text-info">Customer Name</label>
            ...
            <fieldset class="border-bottom border-info">
                ...
                <table class="table table-hover table-striped table-bordered" id="service-list">
                    ...
                    <thead>
                        <tr class="bg-lightblue text-light" style="background: #466d75 !important;">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="pl-4">
                            <?php if($status == 1): ?>
                                <span class="badge badge-pill badge-success" style="font-size: 1rem;">Paid</span>
                            <?php else: ?>
                                <span class="badge badge-pill badge-primary" style="font-size: 1rem;">Pending</span>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
    ...
    <div class="card-footer text-center">
            ...
            <a class="btn btn-flat btn-sn btn-dark" href="<?php echo home_url."?page=invoice_list" ?>">Back to List</a>
    </div>
</div>
<script>
    $(function(){
